...
class CrawlIsc(Task):
    ...
    def save_info(self, domains, source, crawl_time):
        ...
        self.logger.info("isc 共收集{0}条数据， 新数据{1}条".format(all_count, avail_count))
        self.logger.info("isc 抓取时间{0}，数据遍历时间{1}".format(crawl_time, storage_time))
